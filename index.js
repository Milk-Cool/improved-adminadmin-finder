...
const testOne = async (host, browser) => {
    ...
    if(WEB) {
        try {
            ...
            await page.type("input[autocomplete=\"username\"],input[name=\"user\"],input[name=\"username\"],input[name=\"login\"],input[name=\"loginLogin\"],input[type=\"text\"]", "admin");
            await page.type("input[autocomplete=\"password\"],input[type=\"password\"],input[name=\"pass\"],input[name=\"passphrase\"],input[name=\"password\"]", "admin");
